"""
Código ejemplo de la clase 1.5.1.8

Modificar, crear un documento XML.
"""
...
# Crea un nuevos nodos dentro de un elemento del árbol del XML.
...
# Añade los nuevos elementos al documento.
